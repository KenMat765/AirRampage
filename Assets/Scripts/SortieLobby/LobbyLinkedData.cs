    ...
    public static LobbyLinkedData I
    {
        get
        {
            if (instance == null)
            {
                ...
                // NetworkObject is also necessary for class which inherits NetworkBehaviour.
                if (instance.GetComponent<NetworkObject>() == null) { instance.gameObject.AddComponent<NetworkObject>(); }
            }
            return instance;
        }
    }
