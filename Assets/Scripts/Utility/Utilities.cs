...
public class FixedSizeQueue<T>
{
    ...
    public void Enqueue(T item)
    {
        ...
        {
            queue.Dequeue(); // キューが満杯の場合、先頭の要素をポップする
        }
        queue.Enqueue(item);
    }
    ...
    public bool Any(Func<T, bool> predicate) { return queue.Any(predicate); }
    public T Max() { return queue.Max(); }
    public T Min() { return queue.Min(); }
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
