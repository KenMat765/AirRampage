...
static class MethodExtension
{
    ...
    public static Vector2 Screen2Canvas(this Vector2 screenPos)
    {
        float ratioX = screenPos.x/Screen.width;
        float ratioY = screenPos.y/Screen.height;
        Vector2 canvasPos = new Vector2((ratioX - 0.5f)*CanvasManager.canvas_width, (ratioY - 0.5f)*CanvasManager.canvas_height);
        return canvasPos;
    }
